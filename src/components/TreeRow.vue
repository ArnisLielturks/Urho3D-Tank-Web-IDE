  ...
  <li
    ...
    <div class="row_data"
      ...
      <i
        ...
        :class="expanded ? node.icon_expanded : node.icon"
        :style="selected ? node.style_selected : node.style">
      </i>
      <input
        type="checkbox"
        name="item[]"
      ...
      <span
        ...
        data-toggle="tooltip" title="Create new child node (file/folder) for this node"
